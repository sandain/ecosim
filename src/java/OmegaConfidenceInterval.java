 ...
 */
public class OmegaConfidenceInterval {
    ...
    public OmegaConfidenceInterval(MasterVariables masterVariables,
        ...
        inputFileName = workingDirectory + "omegaIn" + suffix + ".dat";
        outputFileName = workingDirectory + "omegaOut" + suffix + ".dat";
        hasRun = false;
    }
    ...
    private void readOutputFile(File outputFile) {
        ...
        try {
            ...
            while (nextLine != null) {
                ...
                // interval for omega, and the likelihood for that values.  The
