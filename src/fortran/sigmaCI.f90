...
program sigmaCI
  ...
  inputFile = 'sigmaIn.dat'
  outputFile = 'sigmaOut.dat'
  ...
  do
    ...
    yvalue = 0.0
    ! Make sure omega is greater than zero.
  ...
  ! Output the answer.
  write (unit = outputUnit, fmt = *) 'upper bound sigma ', upperbound, &
  ...
  ! Output the answer.
  write (unit = outputUnit, fmt = *) 'lower bound sigma ', xlowerbound, &
